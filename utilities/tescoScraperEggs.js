  ...
  try {
    while (count < 6) {
      for (const element of elements) {
        ...
        const prodNumbers = {
          "Tesco Medium Free Range Eggs 6 Pack": 250802613,
          "Big & Fresh Mixed Sized Eggs 6 Pack": 253270171,
        ...
        const prodImg = {
          250802613:
            "https://digitalcontent.api.tesco.com/v2/media/ghs/b4147169-aef2-4677-98a3-d31736379066/ee02524e-e3a5-408d-8172-b7d9cccb6b5a.jpeg?h=540&w=540",
          253270171:
            "https://digitalcontent.api.tesco.com/v2/media/ghs/2eb968eb-b8ba-4e83-807c-9045a458e1e0/361ba900-c538-4f11-b808-ed10a1548ddd.jpeg?h=540&w=540",
          299626009:
            "https://digitalcontent.api.tesco.com/v2/media/ghs/df176611-9b0d-4489-b9ac-fa20964dd858/b80df98c-6159-4be1-9f43-d67341e0cb52.jpeg?h=540&w=540",
          250802567:
        ...
        const ProdDesc = {
          ...
          253270171: "Eggs of different sizes.",
...
async function WebScrapingLocalTestEggs() {
  try {
    ...
    await driver.get(
      "https://www.tesco.com/groceries/en-GB/shop/fresh-food/milk-butter-and-eggs/eggs?sortBy=price-ascending"
    );
